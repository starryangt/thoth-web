module Download
    ...
    let CheckAndDeleteDirectory filepath =
        match (Directory.Exists(filepath)) with
        |false -> ()
        |true -> Directory.Delete(filepath, true)
